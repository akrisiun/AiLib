...
SELECT * FROM @ExplicitConstructors"
        ...
        private void Issue261_Decimals_ADONET(bool setPrecisionScaleViaAbstractApi)
        {
            ...
            using (var cmd = connection.CreateCommand())
            {
                ...
                {
#if DNXCORE50
                    // #region Assembly System.Data.Common, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a
                    // C:\Users\%%\.dnx\packages\System.Data.Common\4.0.0\ref\dotnet\System.Data.Common.dll
